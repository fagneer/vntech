...
<div class="container p-2 pt-4 col-lg-8 offset-lg-2">
    <main class="alert alert-light container">
        <div class="py-3 pt-5 text-center p-3">
            ...
            <h2>Esporte IFCE</h2>
            <hr>
            <p class="lead ">Abaixo você encontra as políticas de privacidade da aplicação.</p>
            <hr>
        ...
        <div class="row g-5">
            ...
            <div class=" col-lg-10 offset-lg-1">
                <h4 class="mb-4">Políticas de Privacidade</h4>
